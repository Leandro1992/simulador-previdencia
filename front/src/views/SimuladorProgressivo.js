...
function SimuladorProgressivo() {
    ...
    const generateFile = () => {
        ...
        if (errors.length > 0) {
            ...
            axios.post('/api/simulador-progressivo', form, {
                headers: {
        ...
        <header className="App-header">
            <Container >
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={8}>
                        <Box>
                            <Alert severity="info"> Simulador Progressivo de renda
                            </Alert>
                            <Collapse in={open}>
                                <Alert
                                    variant="outlined"
...
export default SimuladorProgressivo;